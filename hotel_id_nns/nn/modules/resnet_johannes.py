...
class ResNet(nn.Module):
    ...
    def __init__(self, layers, num_classes, image_channels=3, use_big_resnet_blocks=True):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(image_channels, 64, kernel_size=7, stride=2, padding=3), nn.BatchNorm2d(64),
...
class ResNet18(ResNet):
    ...
    def __init__(self, num_classes, image_channels=3, use_big_resnet_blocks=True):
        super().__init__([2, 2, 2, 2], num_classes, image_channels, use_big_resnet_blocks)


class ResNet34(ResNet):

    def __init__(self, num_classes, image_channels=3, use_big_resnet_blocks=True):
        super().__init__([3, 4, 6, 3], num_classes, image_channels, use_big_resnet_blocks)
...
class ResNet101(ResNet):
    ...
    def __init__(self, num_classes, image_channels=3, use_big_resnet_blocks=True):
        super().__init__([3, 4, 23, 3], num_classes, image_channels, use_big_resnet_blocks)
