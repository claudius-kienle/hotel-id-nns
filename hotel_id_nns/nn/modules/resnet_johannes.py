...
def ResNet18(num_classes, image_channels=3):
    return ResNet([2, 2, 2, 2], image_channels, num_classes, use_big_resnet_blocks=False)

def ResNet34(num_classes, image_channels=3):
    return ResNet([3, 4, 6, 3], image_channels, num_classes, use_big_resnet_blocks=False)
